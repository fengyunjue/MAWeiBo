...
{
    // 设置时间
    [self setFormatter:created_at];
}

- (void)setFormatter:(NSString *)created_at
{
    // 获取微博发送时间
    NSDateFormatter *inputFormatter  =[[NSDateFormatter alloc]init];
    [inputFormatter setLocale:[[NSLocale alloc]initWithLocaleIdentifier:@"en_US"]];
    [inputFormatter setDateFormat:@"EEE MMM d HH:mm:ss Z yyyy"];
    NSDate *createdTime = [inputFormatter dateFromString:created_at];
...
//    MALog(@"%@",timeStr);
    ...
    _created_at = [self time:created_at];
}
/**
